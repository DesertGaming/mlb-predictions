...
QUERY_PATH = os.path.join(BASE_DIR, "..", "sql", "queries", "linear_backtest_data.sql")
...
for k in range(120, 140):
    squared_errors = []
    for season, team_id, runs_scored, runs_allowed, games_played, games_remaining, wins_so_far, final_wins, preseason_strength in per_game_data:
